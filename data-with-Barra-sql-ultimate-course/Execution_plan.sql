...
--YOU CAN ALSO FORCE THE SQL TO USE THE SPECIFIC INDEX THAT YOU HAVE DESIGNED
SELECT 
	O.Sales,
	C.Country
FROM Sales.Orders O
...
ON O.CustomerID = C.CustomerID
--OPTION (HASH JOIN);-- YOU CANNOT FOR THE JOIN TECHNIQUE WHILE YOU ARE FORCING THE INDEX SEEK 

--YOU CAN INCLUDE PARTICULAR SELECTION TYPE SUCH AS : HASH , MERGE OR NESTED LOOPS :
